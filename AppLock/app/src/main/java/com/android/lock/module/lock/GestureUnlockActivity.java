package com.android.lock.module.lock;
...
import com.android.lock.db.CommLockInfoManager;
import com.android.lock.module.main.MainActivity;
import com.android.lock.service.LockService;
import com.android.lock.utils.LockPatternUtils;
import com.android.lock.utils.LockUtil;
import com.android.lock.utils.SpUtil;
import com.android.lock.utils.StatusBarUtil;
import com.android.lock.widget.LockPatternView;
import com.android.lock.widget.LockPatternViewPattern;
import com.android.lock.widget.UnLockMenuPopWindow;
...
public class GestureUnlockActivity extends BaseActivity implements View.OnClickListener {
	...
	private android.support.v4.hardware.fingerprint.FingerprintManagerCompat.AuthenticationCallback mAuthenticationCallback = new AuthenticationCallback() {
    ...
    protected void initViews(Bundle savedInstanceState) {
        ...
        mFmc.authenticate(null,0, new CancellationSignal(), mAuthenticationCallback, null);

        if (mFmc.hasEnrolledFingerprints() ) {

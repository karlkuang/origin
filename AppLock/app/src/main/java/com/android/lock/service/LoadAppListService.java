package com.android.lock.service;
...
import com.android.lock.bean.FaviterInfo;
...
public class LoadAppListService extends IntentService {
    ...
    public static final String ACTION_START_LOAD_APP = "com.android.lock.service.action.LOADAPP";
